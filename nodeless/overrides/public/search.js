...
dbkjs.modules.search.createSearchGroup = function() {
    ...
    var search_input = $('<input id="search_input" name="search_input" autocomplete="off" type="text" class="form-control" placeholder="' + i18n.t("search.addressplaceholder") + '">');

    if(dbkjs.options.searchTabs) {
        var search_tabs = $(
            '<ul id="search_tabs" class="nav nav-pills" style="margin-bottom: 10px">' +
                    '<li id="search_li_dbk"><a data-toggle="tab" href="#" id="s_dbk"><i class="fa fa-building"></i> ' + i18n.t("search.dbk") + '</a></li>' +
                    ...
                    '<li id="search_li_wo" style="display: ' + (dbkjs.modules.waterongevallen.features && dbkjs.modules.waterongevallen.features.length > 0 ? "block" : "none") + '"><a data-toggle="tab" href="#" id="s_wo"><i class="fa fa-life-buoy"></i> ' + i18n.t("search.wo") + '</a></li>' +
                    '<li id="search_li_address" class="active"><a  data-toggle="tab" href="#" id="s_address"><i class="fa fa-home"></i> ' + i18n.t("search.address") + '</a></li>' +
                '</ul>'
        );
